...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _determinePosition() async {
    ...
    try {
      ...
      params.madhab = (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi))) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)) : (currentFiqh == 'hanafi' ? (currentFiqh == 'hanafi' ? Madhab.hanafi : Madhab.shafi) : Madhab.shafi)))));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _cityName,
                style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black, fontWeight: FontWeight.bold, fontWeight: FontWeight.bold, fontWeight: FontWeight.bold),
              ),
